import style from './admin-orders-empty.module.css';

export const AdminNullOrdersPage = () => {
  return (
    <div className={style.orders_page}>
      <h1 className={style.page_title}>Все заказы</h1>
      
      <div className={style.orders_empty_state}>
        ...
        <p className={style.empty_text}>За сегодня пока нет заказов</p>
        <p className={style.empty_desc}>Здесь будут отображаться все сегодняшние заказы</p>
      </div>
    </div>
  );
};